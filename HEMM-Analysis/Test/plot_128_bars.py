...
plt.title('Execution time break down (key=128)', pad=26, fontsize=24)
...
plt.legend(loc='upper center', fontsize=14, ncol=5)

# Add vertical lines to separate groups visually
offset = 1.5  # Adjust this value as needed to move the line one position to the right
